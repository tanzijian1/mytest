...
public class CapmarketversionBVO extends SuperVO {
	
/**
*资本市场融资方案版本主键
*/
public java.lang.String pk_fiscehmeversion_capmarket;
/**
*自定义项1
*/
...
/**
* 属性 pk_fiscehmeversion_capmarket的Getter方法.属性名：资本市场融资方案版本主键
*  创建日期:2019-11-11
* @return java.lang.String
*/
public java.lang.String getPk_fiscehmeversion_capmarket() {
return this.pk_fiscehmeversion_capmarket;
} 

/**
* 属性pk_fiscehmeversion_capmarket的Setter方法.属性名：资本市场融资方案版本主键
* 创建日期:2019-11-11
* @param newPk_fiscehmeversion_capmarket java.lang.String
*/
public void setPk_fiscehmeversion_capmarket ( java.lang.String pk_fiscehmeversion_capmarket) {
this.pk_fiscehmeversion_capmarket=pk_fiscehmeversion_capmarket;
} 
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("tg.tgrz_capmarketversion_b");
    }
   }
