...
public class NFISchemeversionBVO extends SuperVO {
	
/**
*非银行融资方案版本主键
*/
public java.lang.String pk_fiscehmeversion_schedule;
/**
*自定义项1
*/
...
/**
* 属性 pk_fiscehmeversion_schedule的Getter方法.属性名：非银行融资方案版本主键
*  创建日期:2019-11-11
* @return java.lang.String
*/
public java.lang.String getPk_fiscehmeversion_schedule() {
return this.pk_fiscehmeversion_schedule;
} 

/**
* 属性pk_fiscehmeversion_schedule的Setter方法.属性名：非银行融资方案版本主键
* 创建日期:2019-11-11
* @param newPk_fiscehmeversion_schedule java.lang.String
*/
public void setPk_fiscehmeversion_schedule ( java.lang.String pk_fiscehmeversion_schedule) {
this.pk_fiscehmeversion_schedule=pk_fiscehmeversion_schedule;
} 
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("tg.tgrz_nfischemeversion_b");
    }
   }
