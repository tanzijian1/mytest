...
public class FinancingTotal extends SuperVO {
...
*月度累计计划放款
*/
public nc.vo.pub.lang.UFDouble moon_total;
/**
*自定义项1
*/
...
/**
* 属性 dyear_change的Getter方法.属性名：调整年
*  创建日期:2019-7-9
...
/**
* 属性dyear_change的Setter方法.属性名：调整年
* 创建日期:2019-7-9
...
/**
* 属性 dmoon_change的Getter方法.属性名：调整月份
*  创建日期:2019-7-9
...
/**
* 属性dmoon_change的Setter方法.属性名：调整月份
* 创建日期:2019-7-9
...
/**
* 属性 moon_total的Getter方法.属性名：月度累计计划放款
*  创建日期:2019-7-9
* @return nc.vo.pub.lang.UFDouble
*/
public nc.vo.pub.lang.UFDouble getMoon_total() {
return this.moon_total;
} 

/**
* 属性moon_total的Setter方法.属性名：月度累计计划放款
* 创建日期:2019-7-9
* @param newMoon_total nc.vo.pub.lang.UFDouble
*/
public void setMoon_total ( nc.vo.pub.lang.UFDouble moon_total) {
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("tg.FinancingTotal");
    }
   }
