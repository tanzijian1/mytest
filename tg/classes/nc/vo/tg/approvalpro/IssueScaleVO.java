...
public class IssueScaleVO extends SuperVO {
	
/**
*主键
*/
public java.lang.String pk_issuescale;
/**
*行号
*/
...
/**
* 属性 pk_issuescale的Getter方法.属性名：主键
*  创建日期:2020-8-21
* @return java.lang.String
*/
public java.lang.String getPk_issuescale() {
return this.pk_issuescale;
} 

/**
* 属性pk_issuescale的Setter方法.属性名：主键
* 创建日期:2020-8-21
* @param newPk_issuescale java.lang.String
*/
public void setPk_issuescale ( java.lang.String pk_issuescale) {
this.pk_issuescale=pk_issuescale;
} 
...
* @return String
*/
public String getPk_appro(){
return this.pk_appro;
}
/**
* 属性生成上层主键的Setter方法.属性名：上层主键
* 创建日期:2020-8-21
* @param newPk_appro String
*/
public void setPk_appro(String pk_appro){
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("tg.issuescale");
    }
   }
