...
public class MasterDataXFVO extends SuperVO {
	
/**
*项目分期主键
*/
public java.lang.String pk_mtdata_xf;
/**
*行号
*/
...
/**
* 属性 pk_mtdata_xf的Getter方法.属性名：项目分期主键
*  创建日期:2020-7-23
* @return java.lang.String
*/
public java.lang.String getPk_mtdata_xf() {
return this.pk_mtdata_xf;
} 

/**
* 属性pk_mtdata_xf的Setter方法.属性名：项目分期主键
* 创建日期:2020-7-23
* @param newPk_mtdata_xf java.lang.String
*/
public void setPk_mtdata_xf ( java.lang.String pk_mtdata_xf) {
this.pk_mtdata_xf=pk_mtdata_xf;
} 
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("tg.masterdata_xf");
    }
   }
