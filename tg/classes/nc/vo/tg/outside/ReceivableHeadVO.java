...
public class ReceivableHeadVO implements Serializable {
	...
	private String Hyperlinks;// 综合商城附件超链接
	private String projectphase;// 项目阶段
	private String memo;// 备注
	private String confiscatedmoney;// 是否罚没
	...
	public String getConfiscatedmoney() {
		return confiscatedmoney;
	}

	public void setConfiscatedmoney(String confiscatedmoney) {
		this.confiscatedmoney = confiscatedmoney;
	}
