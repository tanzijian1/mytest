...
public class ProjectDataFBVO extends SuperVO {
	
/**
*银行融资方案主键
*/
public java.lang.String pk_projectdata_fb;
/**
*自定义项1
*/
...
/**
* 属性 pk_projectdata_fb的Getter方法.属性名：银行融资方案主键
*  创建日期:2019-11-25
* @return java.lang.String
*/
public java.lang.String getPk_projectdata_fb() {
return this.pk_projectdata_fb;
} 

/**
* 属性pk_projectdata_fb的Setter方法.属性名：银行融资方案主键
* 创建日期:2019-11-25
* @param newPk_projectdata_fb java.lang.String
*/
public void setPk_projectdata_fb ( java.lang.String pk_projectdata_fb) {
this.pk_projectdata_fb=pk_projectdata_fb;
} 
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("tg.ProjectDataFBVO");
    }
   }
