...
public class ConstructionSupportingSalesInformationVO extends SuperVO {
	
/**
*公建配套销售信息主键
*/
public java.lang.String pk_construction_supporting_b;
/**
*自定义项1
*/
...
/**
* 属性 pk_construction_supporting_b的Getter方法.属性名：公建配套销售信息主键
*  创建日期:2020-8-18
* @return java.lang.String
*/
public java.lang.String getPk_construction_supporting_b() {
return this.pk_construction_supporting_b;
} 

/**
* 属性pk_construction_supporting_b的Setter方法.属性名：公建配套销售信息主键
* 创建日期:2020-8-18
* @param newPk_construction_supporting_b java.lang.String
*/
public void setPk_construction_supporting_b ( java.lang.String pk_construction_supporting_b) {
this.pk_construction_supporting_b=pk_construction_supporting_b;
} 
...
* 创建日期:2020-8-18
* @param newPk_projectdata String
*/
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("tg.ConstructionSupportingSalesInformationVO");
    }
   }
