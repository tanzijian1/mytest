...
public class ResidentialSalesInformationVO extends SuperVO {
	
/**
*住宅销售信息主键
*/
public java.lang.String pk_residential_sales_b;
/**
*自定义项1
*/
...
/**
* 属性 pk_residential_sales_b的Getter方法.属性名：住宅销售信息主键
*  创建日期:2020-8-18
* @return java.lang.String
*/
public java.lang.String getPk_residential_sales_b() {
return this.pk_residential_sales_b;
} 

/**
* 属性pk_residential_sales_b的Setter方法.属性名：住宅销售信息主键
* 创建日期:2020-8-18
* @param newPk_residential_sales_b java.lang.String
*/
public void setPk_residential_sales_b ( java.lang.String pk_residential_sales_b) {
this.pk_residential_sales_b=pk_residential_sales_b;
} 
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("tg.ResidentialSalesInformationVO");
    }
   }
