...
public class ProjectDataPVO extends SuperVO {
	
/**
*项目规划数据主键
*/
public java.lang.String pk_projectdata_p;
/**
*自定义项1
*/
...
/**
* 属性 pk_projectdata_p的Getter方法.属性名：项目规划数据主键
*  创建日期:2019-11-18
* @return java.lang.String
*/
public java.lang.String getPk_projectdata_p() {
return this.pk_projectdata_p;
} 

/**
* 属性pk_projectdata_p的Setter方法.属性名：项目规划数据主键
* 创建日期:2019-11-18
* @param newPk_projectdata_p java.lang.String
*/
public void setPk_projectdata_p ( java.lang.String pk_projectdata_p) {
this.pk_projectdata_p=pk_projectdata_p;
} 
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("tg.ProjectDataPVO");
    }
   }
