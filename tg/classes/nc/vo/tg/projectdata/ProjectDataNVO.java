...
public class ProjectDataNVO extends SuperVO {
	
/**
*非银行融资方案主键
*/
public java.lang.String pk_projectdata_n;
/**
*自定义项1
*/
...
/**
* 属性 pk_projectdata_n的Getter方法.属性名：非银行融资方案主键
*  创建日期:2019-11-13
* @return java.lang.String
*/
public java.lang.String getPk_projectdata_n() {
return this.pk_projectdata_n;
} 

/**
* 属性pk_projectdata_n的Setter方法.属性名：非银行融资方案主键
* 创建日期:2019-11-13
* @param newPk_projectdata_n java.lang.String
*/
public void setPk_projectdata_n ( java.lang.String pk_projectdata_n) {
this.pk_projectdata_n=pk_projectdata_n;
} 
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("tg.ProjectDataNVO");
    }
   }
