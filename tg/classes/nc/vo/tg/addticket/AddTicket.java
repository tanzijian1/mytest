...
public class AddTicket extends SuperVO {
	
/**
*主键
*/
public java.lang.String pk_ticket;
/**
*code
*/
...
/**
* 属性 pk_ticket的Getter方法.属性名：主键
*  创建日期:2020-1-7
* @return java.lang.String
*/
public java.lang.String getPk_ticket() {
return this.pk_ticket;
} 

/**
* 属性pk_ticket的Setter方法.属性名：主键
* 创建日期:2020-1-7
* @param newPk_ticket java.lang.String
*/
public void setPk_ticket ( java.lang.String pk_ticket) {
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("tg.addTicket");
    }
   }
