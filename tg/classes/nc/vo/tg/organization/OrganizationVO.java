 ...
 * @version NCPrj ??
 */
public class OrganizationVO extends nc.vo.pub.SuperVO{
    ...
    public static final String PK_ORGANIZATION = "pk_organization";
	...
	/**
	 * 属性 pk_organization的Getter方法.属性名：主键
	 *  创建日期:2019-6-10
	...
	/**
	 * 属性pk_organization的Setter方法.属性名：主键
	 * 创建日期:2019-6-10
	 * @param newPk_organization java.lang.String
	 */
	public void setPk_organization (java.lang.String newPk_organization ) {
	 	this.pk_organization = newPk_organization;
	} 	 
	...
	/**
	 * 属性 pk_organizationtype的Getter方法.属性名：机构类型
	 *  创建日期:2019-6-10
	 * @return java.lang.String
	 */
	...
	/**
	 * 属性pk_organizationtype的Setter方法.属性名：机构类型
	 * 创建日期:2019-6-10
	...
	/**
	 * 属性subbranch的Setter方法.属性名：支行
	 * 创建日期:2019-6-10
	 * @param newSubbranch java.lang.String
	 */
	public void setSubbranch (java.lang.String newSubbranch ) {
	 	this.subbranch = newSubbranch;
	} 	 
	
	/**
	 * 属性 custype的Getter方法.属性名：我司所属客户类型
	 *  创建日期:2019-6-10
	 * @return java.lang.String
	 */
	...
	/**
	 * 属性 pk_father的Getter方法.属性名：上级机构
	 *  创建日期:2019-6-10
	 * @return java.lang.String
	 */
	...
	@nc.vo.annotation.MDEntityInfo(beanFullclassName = "nc.vo.tg.organization.OrganizationVO" )
	public IVOMeta getMetaData() {
		return VOMetaFactory.getInstance().getVOMeta("tg.OrganizationVO");
