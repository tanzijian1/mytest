...
public class FischemePushStandardBVO extends SuperVO {
	
/**
*融资方案推进标准银行主键
*/
public java.lang.String pk_fischemepushstandard_b;
/**
*自定义项1
*/
...
/**
* 属性 pk_fischemepushstandard_b的Getter方法.属性名：融资方案推进标准银行主键
*  创建日期:2019-11-22
* @return java.lang.String
*/
public java.lang.String getPk_fischemepushstandard_b() {
return this.pk_fischemepushstandard_b;
} 

/**
* 属性pk_fischemepushstandard_b的Setter方法.属性名：融资方案推进标准银行主键
* 创建日期:2019-11-22
* @param newPk_fischemepushstandard_b java.lang.String
*/
public void setPk_fischemepushstandard_b ( java.lang.String pk_fischemepushstandard_b) {
this.pk_fischemepushstandard_b=pk_fischemepushstandard_b;
} 
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("tg.FischemePushStandardBVO");
    }
   }
