...
public class FischemePushStandardNVO extends SuperVO {
	
/**
*融资方案推进标准非银行主键
*/
public java.lang.String pk_fischemepushstandard_n;
/**
*自定义项1
*/
...
/**
* 属性 pk_fischemepushstandard_n的Getter方法.属性名：融资方案推进标准非银行主键
*  创建日期:2019-11-22
* @return java.lang.String
*/
public java.lang.String getPk_fischemepushstandard_n() {
return this.pk_fischemepushstandard_n;
} 

/**
* 属性pk_fischemepushstandard_n的Setter方法.属性名：融资方案推进标准非银行主键
* 创建日期:2019-11-22
* @param newPk_fischemepushstandard_n java.lang.String
*/
public void setPk_fischemepushstandard_n ( java.lang.String pk_fischemepushstandard_n) {
this.pk_fischemepushstandard_n=pk_fischemepushstandard_n;
} 
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("tg.FischemePushStandardNVO");
    }
   }
