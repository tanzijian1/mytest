...
public class FischemePushStandardCVO extends SuperVO {
	
/**
*融资方案推进标准资本市场主键
*/
public java.lang.String pk_fischemepushstandard_c;
/**
*自定义项1
*/
...
*上层单据主键
*/
public String pk_fispushstandard;
/**
*时间戳
*/
...
/**
* 属性 pk_fischemepushstandard_c的Getter方法.属性名：融资方案推进标准资本市场主键
*  创建日期:2019-11-22
* @return java.lang.String
*/
public java.lang.String getPk_fischemepushstandard_c() {
return this.pk_fischemepushstandard_c;
} 

/**
* 属性pk_fischemepushstandard_c的Setter方法.属性名：融资方案推进标准资本市场主键
* 创建日期:2019-11-22
* @param newPk_fischemepushstandard_c java.lang.String
*/
public void setPk_fischemepushstandard_c ( java.lang.String pk_fischemepushstandard_c) {
this.pk_fischemepushstandard_c=pk_fischemepushstandard_c;
} 
...
* @return String
*/
public String getPk_fispushstandard(){
return this.pk_fispushstandard;
}
/**
* 属性生成上层主键的Setter方法.属性名：上层主键
* 创建日期:2019-11-22
* @param newPk_fispushstandard String
*/
public void setPk_fispushstandard(String pk_fispushstandard){
this.pk_fispushstandard=pk_fispushstandard;
} 
/**
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("tg.FischemePushStandardCVO");
    }
   }
