...
public class SealFlowBodyVO extends SuperVO {
	
/**
*主键
*/
public java.lang.String pk_bstamp;
/**
*行号
*/
...
/**
* 属性 pk_bstamp的Getter方法.属性名：主键
*  创建日期:2020-7-21
* @return java.lang.String
*/
public java.lang.String getPk_bstamp() {
return this.pk_bstamp;
} 

/**
* 属性pk_bstamp的Setter方法.属性名：主键
* 创建日期:2020-7-21
* @param newPk_bstamp java.lang.String
*/
public void setPk_bstamp ( java.lang.String pk_bstamp) {
this.pk_bstamp=pk_bstamp;
} 
...
* @return String
*/
public String getPk_stamp(){
return this.pk_stamp;
}
/**
* 属性生成上层主键的Setter方法.属性名：上层主键
* 创建日期:2020-7-21
* @param newPk_stamp String
*/
public void setPk_stamp(String pk_stamp){
this.pk_stamp=pk_stamp;
} 
/**
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("tg.sealflowbody");
    }
   }
