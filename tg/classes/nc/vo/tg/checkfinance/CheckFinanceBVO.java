...
public class CheckFinanceBVO extends SuperVO {
	
/**
*考核融资金额计算标准表体主键
*/
public java.lang.String pk_checkfinance_b;
/**
*自定义项1
*/
...
/**
* 属性 pk_checkfinance_b的Getter方法.属性名：考核融资金额计算标准表体主键
*  创建日期:2019-11-15
* @return java.lang.String
*/
public java.lang.String getPk_checkfinance_b() {
return this.pk_checkfinance_b;
} 

/**
* 属性pk_checkfinance_b的Setter方法.属性名：考核融资金额计算标准表体主键
* 创建日期:2019-11-15
* @param newPk_checkfinance_b java.lang.String
*/
public void setPk_checkfinance_b ( java.lang.String pk_checkfinance_b) {
this.pk_checkfinance_b=pk_checkfinance_b;
} 
...
* @return String
*/
public String getPk_checkfinance(){
return this.pk_checkfinance;
}
/**
* 属性生成上层主键的Setter方法.属性名：上层主键
* 创建日期:2019-11-15
* @param newPk_checkfinance String
*/
public void setPk_checkfinance(String pk_checkfinance){
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("tg.tgrz_checkfinance_b");
    }
   }
