...
public class CycleBuyingVersionVO extends SuperVO {
...
*循环购买计划版本主键
*/
public java.lang.String pk_cbversion;
/**
*行号
*/
...
/**
* 属性 pk_cbversion的Getter方法.属性名：循环购买计划版本主键
*  创建日期:2020-10-10
* @return java.lang.String
*/
public java.lang.String getPk_cbversion() {
return this.pk_cbversion;
} 

/**
* 属性pk_cbversion的Setter方法.属性名：循环购买计划版本主键
* 创建日期:2020-10-10
* @param newPk_cbversion java.lang.String
*/
public void setPk_cbversion ( java.lang.String pk_cbversion) {
this.pk_cbversion=pk_cbversion;
} 
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("tg.cyclebuying_v");
    }
   }
