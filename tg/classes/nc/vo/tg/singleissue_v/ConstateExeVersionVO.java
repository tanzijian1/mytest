...
public class ConstateExeVersionVO extends SuperVO {
...
*财务顾问费执行情况主键
*/
public java.lang.String pk_cgfzxversion;
/**
*行号
*/
...
*上层单据主键
*/
public String pk_singleversion;
/**
*时间戳
*/
...
/**
* 属性 pk_cgfzxversion的Getter方法.属性名：财务顾问费执行情况主键
*  创建日期:2020-10-10
* @return java.lang.String
*/
public java.lang.String getPk_cgfzxversion() {
return this.pk_cgfzxversion;
} 

/**
* 属性pk_cgfzxversion的Setter方法.属性名：财务顾问费执行情况主键
* 创建日期:2020-10-10
* @param newPk_cgfzxversion java.lang.String
*/
public void setPk_cgfzxversion ( java.lang.String pk_cgfzxversion) {
this.pk_cgfzxversion=pk_cgfzxversion;
} 
...
* @return String
*/
public String getPk_singleversion(){
return this.pk_singleversion;
}
/**
* 属性生成上层主键的Setter方法.属性名：上层主键
* 创建日期:2020-10-10
* @param newPk_singleversion String
*/
public void setPk_singleversion(String pk_singleversion){
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("tg.constateexe_v");
    }
   }
