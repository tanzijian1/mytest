...
public class SingleIssueBVersionVO extends SuperVO {
...
*单期发行子表版本主键
*/
public java.lang.String pk_sibversion;
/**
*行号
*/
...
/**
* 属性 pk_sibversion的Getter方法.属性名：单期发行子表版本主键
*  创建日期:2020-10-10
* @return java.lang.String
*/
public java.lang.String getPk_sibversion() {
return this.pk_sibversion;
} 

/**
* 属性pk_sibversion的Setter方法.属性名：单期发行子表版本主键
* 创建日期:2020-10-10
* @param newPk_sibversion java.lang.String
*/
public void setPk_sibversion ( java.lang.String pk_sibversion) {
this.pk_sibversion=pk_sibversion;
} 
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("tg.singleissueb_v");
    }
   }
