...
public class SingleIssueVersionVO extends SuperVO {
...
*单期发行版本主键
*/
public java.lang.String pk_singleversion;
/**
*来源单据pk
*/
public java.lang.String pk_singleissue;
/**
*版本日期
*/
...
/**
* 属性 pk_singleversion的Getter方法.属性名：单期发行版本主键
*  创建日期:2020-10-10
* @return java.lang.String
*/
public java.lang.String getPk_singleversion() {
return this.pk_singleversion;
} 

/**
* 属性pk_singleversion的Setter方法.属性名：单期发行版本主键
* 创建日期:2020-10-10
* @param newPk_singleversion java.lang.String
*/
public void setPk_singleversion ( java.lang.String pk_singleversion) {
this.pk_singleversion=pk_singleversion;
} 
 
/**
* 属性 pk_singleissue的Getter方法.属性名：来源单据pk
*  创建日期:2020-10-10
* @return java.lang.String
*/
public java.lang.String getPk_singleissue() {
return this.pk_singleissue;
} 

/**
* 属性pk_singleissue的Setter方法.属性名：来源单据pk
* 创建日期:2020-10-10
* @param newPk_singleissue java.lang.String
*/
public void setPk_singleissue ( java.lang.String pk_singleissue) {
...
*  创建日期:2020-10-10
* @return nc.vo.cc.protocol.EmendEnum
*/
...
* 创建日期:2020-10-10
* @param newEmendenum nc.vo.cc.protocol.EmendEnum
*/
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("tg.singleissue_v");
    }
   }
