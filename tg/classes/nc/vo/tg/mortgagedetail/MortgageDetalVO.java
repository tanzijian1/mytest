...
public class MortgageDetalVO extends SuperVO {
	
/**
*按揭协议明细主键
*/
public java.lang.String pk_mortgag_detal;
/**
*名称
*/
...
/**
* 属性 pk_mortgag_detal的Getter方法.属性名：按揭协议明细主键
*  创建日期:2020-8-4
* @return java.lang.String
*/
public java.lang.String getPk_mortgag_detal() {
return this.pk_mortgag_detal;
} 

/**
* 属性pk_mortgag_detal的Setter方法.属性名：按揭协议明细主键
* 创建日期:2020-8-4
* @param newPk_mortgag_detal java.lang.String
*/
public void setPk_mortgag_detal ( java.lang.String pk_mortgag_detal) {
this.pk_mortgag_detal=pk_mortgag_detal;
} 
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("tg.MortgageDetalVO");
    }
   }
