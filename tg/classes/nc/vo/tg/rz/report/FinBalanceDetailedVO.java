 ...
 */
public class FinBalanceDetailedVO implements Serializable, Cloneable {
	UFDouble sortnumglobal;//序号
	...
	String remark;//抵押条件备注
	String pledgor1;//出质人（一）	
	String equity1;//标的股权（一）
	...
	UFDouble sumPayinterestAmount;//累计已付利息金额
	String contractremark;//贷款合同备注
	UFDouble fin_amount;// 融资金额
	String loantatol_amount;// 累计放款金额
	String fin_balance;// 融资余额
	...
	*/
	...
	public UFDouble getSumPayinterestAmount() {
		return sumPayinterestAmount;
	}

	public void setSumPayinterestAmount(UFDouble sumPayinterestAmount) {
		this.sumPayinterestAmount = sumPayinterestAmount;
	}

	public String getFin_balance() {
		return fin_balance;
	}

	public void setFin_balance(String fin_balance) {
