 ...
 */
public class RepAndPayTotalVO implements Serializable, Cloneable {
	...
	UFDouble repmonplantotal1_amount;// N月计划还款金额(合同约定)
	UFDouble repmonplantotal2_amount;// N月计划还款金额(现金流)
	UFDouble repmonactualtotal_amount;// N月实际还款金额
	UFDouble ipmonplantotal1_amount;// N月付息金额(合同约定)
	UFDouble ipmonplantotal2_amount;// N月付息金额(现金流)
	UFDouble ipmonactualtotal_amount;//N月实际付息金额
	UFDouble advmonplantotal_amount;// N月计划财务顾问费用金额
	UFDouble advmonactualtotal_amount;// N月实际财务顾问费用金额
	...
	public UFDouble getRepmonplantotal1_amount() {
		return repmonplantotal1_amount;
	}

	public void setRepmonplantotal1_amount(UFDouble repmonplantotal1_amount) {
		this.repmonplantotal1_amount = repmonplantotal1_amount;
	}

	public UFDouble getRepmonplantotal2_amount() {
		return repmonplantotal2_amount;
	}

	public void setRepmonplantotal2_amount(UFDouble repmonplantotal2_amount) {
		this.repmonplantotal2_amount = repmonplantotal2_amount;
	}
	...
	public UFDouble getIpmonplantotal1_amount() {
		return ipmonplantotal1_amount;
	}

	public void setIpmonplantotal1_amount(UFDouble ipmonplantotal1_amount) {
		this.ipmonplantotal1_amount = ipmonplantotal1_amount;
	}

	public UFDouble getIpmonplantotal2_amount() {
		return ipmonplantotal2_amount;
	}

	public void setIpmonplantotal2_amount(UFDouble ipmonplantotal2_amount) {
		this.ipmonplantotal2_amount = ipmonplantotal2_amount;
	}
