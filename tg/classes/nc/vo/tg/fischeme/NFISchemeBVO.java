...
public class NFISchemeBVO extends SuperVO {
	
/**
*非银行融资方案主键
*/
public java.lang.String pk_fiscehme_schedule;
/**
*自定义项1
*/
...
/**
* 属性 pk_fiscehme_schedule的Getter方法.属性名：非银行融资方案主键
*  创建日期:2019-11-11
* @return java.lang.String
*/
public java.lang.String getPk_fiscehme_schedule() {
return this.pk_fiscehme_schedule;
} 

/**
* 属性pk_fiscehme_schedule的Setter方法.属性名：非银行融资方案主键
* 创建日期:2019-11-11
* @param newPk_fiscehme_schedule java.lang.String
*/
public void setPk_fiscehme_schedule ( java.lang.String pk_fiscehme_schedule) {
this.pk_fiscehme_schedule=pk_fiscehme_schedule;
} 
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("tg.tgrz_nfischeme_b");
    }
   }
