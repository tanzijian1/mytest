...
public class CapmarketBVO extends SuperVO {
	
/**
*资本市场融资方案主键
*/
public java.lang.String pk_fiscehme_capmarket;
/**
*自定义项1
*/
...
/**
* 属性 pk_fiscehme_capmarket的Getter方法.属性名：资本市场融资方案主键
*  创建日期:2019-11-8
* @return java.lang.String
*/
public java.lang.String getPk_fiscehme_capmarket() {
return this.pk_fiscehme_capmarket;
} 

/**
* 属性pk_fiscehme_capmarket的Setter方法.属性名：资本市场融资方案主键
* 创建日期:2019-11-8
* @param newPk_fiscehme_capmarket java.lang.String
*/
public void setPk_fiscehme_capmarket ( java.lang.String pk_fiscehme_capmarket) {
this.pk_fiscehme_capmarket=pk_fiscehme_capmarket;
} 
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("tg.tgrz_capmarket_b");
    }
   }
