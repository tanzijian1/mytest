...
public class ProgressCtrVersionVO extends SuperVO {
	
/**
*主键
*/
public java.lang.String pk_progressversion;
/**
*行号
*/
...
/**
* 属性 pk_progressversion的Getter方法.属性名：主键
*  创建日期:2020-8-21
* @return java.lang.String
*/
public java.lang.String getPk_progressversion() {
return this.pk_progressversion;
} 

/**
* 属性pk_progressversion的Setter方法.属性名：主键
* 创建日期:2020-8-21
* @param newPk_progressversion java.lang.String
*/
public void setPk_progressversion ( java.lang.String pk_progressversion) {
this.pk_progressversion=pk_progressversion;
} 
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("tg.progressctrversion");
    }
   }
