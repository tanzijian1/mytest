...
public class ApprovalProVersionVO extends SuperVO {
...
/**
* 属性 pk_approversion的Getter方法.属性名：批文方案版本主键
*  创建日期:2020-8-21
...
/**
* 属性pk_approversion的Setter方法.属性名：批文方案版本主键
* 创建日期:2020-8-21
...
/**
* 属性 pk_appro的Getter方法.属性名：来源单号pk
*  创建日期:2020-8-21
* @return java.lang.String
*/
...
/**
* 属性pk_appro的Setter方法.属性名：来源单号pk
* 创建日期:2020-8-21
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("tg.approvalproversion");
    }
   }
