...
public class IssueScaleVersionVO extends SuperVO {
	
/**
*主键
*/
public java.lang.String pk_issuescaleversion;
/**
*行号
*/
...
/**
* 属性 pk_issuescaleversion的Getter方法.属性名：主键
*  创建日期:2020-8-21
* @return java.lang.String
*/
public java.lang.String getPk_issuescaleversion() {
return this.pk_issuescaleversion;
} 

/**
* 属性pk_issuescaleversion的Setter方法.属性名：主键
* 创建日期:2020-8-21
* @param newPk_issuescaleversion java.lang.String
*/
public void setPk_issuescaleversion ( java.lang.String pk_issuescaleversion) {
this.pk_issuescaleversion=pk_issuescaleversion;
} 
...
* @return String
*/
public String getPk_approversion(){
return this.pk_approversion;
}
/**
* 属性生成上层主键的Setter方法.属性名：上层主键
* 创建日期:2020-8-21
* @param newPk_approversion String
*/
public void setPk_approversion(String pk_approversion){
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("tg.issuescaleversion");
    }
   }
