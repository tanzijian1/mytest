...
public class OutbillBVO extends SuperVO {
	
/**
*出库单表体主键
*/
public java.lang.String pk_outbill_o;
/**
*摘要
*/
public java.lang.String pk_summary;
/**
*领用数量
*/
...
/**
* 属性 pk_outbill_o的Getter方法.属性名：出库单表体主键
*  创建日期:2019-8-29
* @return java.lang.String
*/
public java.lang.String getPk_outbill_o() {
return this.pk_outbill_o;
} 

/**
* 属性pk_outbill_o的Setter方法.属性名：出库单表体主键
* 创建日期:2019-8-29
* @param newPk_outbill_o java.lang.String
*/
public void setPk_outbill_o ( java.lang.String pk_outbill_o) {
this.pk_outbill_o=pk_outbill_o;
} 
 
/**
* 属性 pk_summary的Getter方法.属性名：摘要
*  创建日期:2019-8-29
* @return nc.vo.fipub.summary.SummaryVO
*/
public java.lang.String getPk_summary() {
return this.pk_summary;
} 

/**
* 属性pk_summary的Setter方法.属性名：摘要
* 创建日期:2019-8-29
* @param newPk_summary nc.vo.fipub.summary.SummaryVO
*/
public void setPk_summary ( java.lang.String pk_summary) {
this.pk_summary=pk_summary;
} 
 
/**
* 属性 quantity_de的Getter方法.属性名：领用数量
*  创建日期:2019-8-29
...
/**
* 属性quantity_de的Setter方法.属性名：领用数量
* 创建日期:2019-8-29
...
* @return String
*/
public String getPk_outbill_h(){
return this.pk_outbill_h;
}
/**
* 属性生成上层主键的Setter方法.属性名：上层主键
* 创建日期:2019-8-29
* @param newPk_outbill_h String
*/
public void setPk_outbill_h(String pk_outbill_h){
this.pk_outbill_h=pk_outbill_h;
} 
/**
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("tg.outbillBVO");
    }
   }
