...
public class CostAccrueBill extends SuperVO {
	
/**
*计提表头主键
*/
public java.lang.String pk_costaccruebill_h;
/**
*集团
*/
...
/**
* 属性 pk_costaccruebill_h的Getter方法.属性名：计提表头主键
*  创建日期:2019-8-29
* @return java.lang.String
*/
public java.lang.String getPk_costaccruebill_h() {
return this.pk_costaccruebill_h;
} 

/**
* 属性pk_costaccruebill_h的Setter方法.属性名：计提表头主键
* 创建日期:2019-8-29
* @param newPk_costaccruebill_h java.lang.String
*/
public void setPk_costaccruebill_h ( java.lang.String pk_costaccruebill_h) {
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("tg.costAccrueBill");
    }
   }
