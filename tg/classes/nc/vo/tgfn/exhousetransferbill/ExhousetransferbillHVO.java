...
public class ExhousetransferbillHVO extends SuperVO {
	
/**
*换房转账单表头主键
*/
public java.lang.String pk_exhoutranbill_h;
/**
*集团
*/
...
/**
* 属性 pk_exhoutranbill_h的Getter方法.属性名：换房转账单表头主键
*  创建日期:2019-8-29
* @return java.lang.String
*/
public java.lang.String getPk_exhoutranbill_h() {
return this.pk_exhoutranbill_h;
} 

/**
* 属性pk_exhoutranbill_h的Setter方法.属性名：换房转账单表头主键
* 创建日期:2019-8-29
* @param newPk_exhoutranbill_h java.lang.String
*/
public void setPk_exhoutranbill_h ( java.lang.String pk_exhoutranbill_h) {
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("tg.exhousetransferbillHVO");
    }
   }
