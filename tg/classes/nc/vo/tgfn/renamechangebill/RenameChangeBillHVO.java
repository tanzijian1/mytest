...
public class RenameChangeBillHVO extends SuperVO {
	
/**
*更名换票单表头主键
*/
public java.lang.String pk_renamechbill_h;
/**
*收款财务组织
*/
...
/**
* 属性 pk_renamechbill_h的Getter方法.属性名：更名换票单表头主键
*  创建日期:2019-8-29
* @return java.lang.String
*/
public java.lang.String getPk_renamechbill_h() {
return this.pk_renamechbill_h;
} 

/**
* 属性pk_renamechbill_h的Setter方法.属性名：更名换票单表头主键
* 创建日期:2019-8-29
* @param newPk_renamechbill_h java.lang.String
*/
public void setPk_renamechbill_h ( java.lang.String pk_renamechbill_h) {
this.pk_renamechbill_h=pk_renamechbill_h;
} 
 
/**
* 属性 pk_org的Getter方法.属性名：收款财务组织
*  创建日期:2019-8-29
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("tg.renameChangeBillHVO");
    }
   }
