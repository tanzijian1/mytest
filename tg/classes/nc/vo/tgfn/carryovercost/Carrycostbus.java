...
public class Carrycostbus extends SuperVO {
	
/**
*业务页签主键
*/
public java.lang.String pk_business;
/**
*摘要
*/
...
*供应商
*/
public java.lang.String pk_customsupplier;
/**
*会计科目
*/
...
*价税金额
*/
public nc.vo.pub.lang.UFDouble tax_cr;
/**
*借贷方向
*/
...
/**
* 属性 pk_business的Getter方法.属性名：业务页签主键
*  创建日期:2019-9-2
* @return java.lang.String
*/
public java.lang.String getPk_business() {
return this.pk_business;
} 

/**
* 属性pk_business的Setter方法.属性名：业务页签主键
* 创建日期:2019-9-2
* @param newPk_business java.lang.String
*/
public void setPk_business ( java.lang.String pk_business) {
...
/**
* 属性 pk_customsupplier的Getter方法.属性名：供应商
*  创建日期:2019-9-2
* @return nc.vo.bd.cust.CustSupplierVO
*/
public java.lang.String getPk_customsupplier() {
return this.pk_customsupplier;
} 

/**
* 属性pk_customsupplier的Setter方法.属性名：供应商
* 创建日期:2019-9-2
* @param newPk_customsupplier nc.vo.bd.cust.CustSupplierVO
*/
public void setPk_customsupplier ( java.lang.String pk_customsupplier) {
this.pk_customsupplier=pk_customsupplier;
} 
 
/**
* 属性 subjcode的Getter方法.属性名：会计科目
*  创建日期:2019-9-2
* @return java.lang.String
*/
...
/**
* 属性taxcodeid的Setter方法.属性名：税码
* 创建日期:2019-9-2
* @param newTaxcodeid java.lang.String
*/
...
/**
* 属性notax_cr的Setter方法.属性名：无税金额
* 创建日期:2019-9-2
* @param newNotax_cr nc.vo.pub.lang.UFDouble
*/
...
/**
* 属性 local_tax_cr的Getter方法.属性名：税额
*  创建日期:2019-9-2
* @return nc.vo.pub.lang.UFDouble
*/
...
/**
* 属性local_tax_cr的Setter方法.属性名：税额
* 创建日期:2019-9-2
* @param newLocal_tax_cr nc.vo.pub.lang.UFDouble
*/
...
/**
* 属性 tax_cr的Getter方法.属性名：价税金额
*  创建日期:2019-9-2
* @return nc.vo.pub.lang.UFDouble
*/
public nc.vo.pub.lang.UFDouble getTax_cr() {
return this.tax_cr;
} 

/**
* 属性tax_cr的Setter方法.属性名：价税金额
* 创建日期:2019-9-2
* @param newTax_cr nc.vo.pub.lang.UFDouble
*/
public void setTax_cr ( nc.vo.pub.lang.UFDouble tax_cr) {
this.tax_cr=tax_cr;
} 
 
/**
* 属性 def1的Getter方法.属性名：借贷方向
*  创建日期:2019-9-2
* @return nc.vo.gl.vatdetail.DirectionEnum
*/
...
/**
* 属性def1的Setter方法.属性名：借贷方向
* 创建日期:2019-9-2
* @param newDef1 nc.vo.gl.vatdetail.DirectionEnum
*/
...
* @return String
*/
public String getPk_carrycost(){
return this.pk_carrycost;
}
/**
* 属性生成上层主键的Setter方法.属性名：上层主键
* 创建日期:2019-9-2
* @param newPk_carrycost String
*/
public void setPk_carrycost(String pk_carrycost){
this.pk_carrycost=pk_carrycost;
} 
/**
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("tg.carrycostbus");
    }
   }
