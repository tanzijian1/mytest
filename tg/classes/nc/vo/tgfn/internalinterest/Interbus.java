...
public class Interbus extends SuperVO {
...
/**
* 属性def1的Setter方法.属性名：客商
* 创建日期:2019-9-29
* @param newDef1 nc.vo.org.FinanceOrgVO
*/
...
/**
* 属性 uuid_contact的Getter方法.属性名：uuid表头体联系
*  创建日期:2019-9-29
* @return java.lang.String
*/
...
/**
* 属性uuid_contact的Setter方法.属性名：uuid表头体联系
* 创建日期:2019-9-29
...
* @return String
*/
public String getPk_internal(){
return this.pk_internal;
}
/**
* 属性生成上层主键的Setter方法.属性名：上层主键
* 创建日期:2019-9-29
* @param newPk_internal String
*/
public void setPk_internal(String pk_internal){
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("tg.interbus");
    }
   }
