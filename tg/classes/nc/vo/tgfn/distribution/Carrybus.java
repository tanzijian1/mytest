...
public class Carrybus extends SuperVO {
...
*结算方式
*/
public java.lang.Integer pk_balatype;
/**
*收款银行账户
*/
...
/**
* 属性 local_money_cr的Getter方法.属性名：含税总金额
*  创建日期:2019-8-30
...
/**
* 属性local_money_cr的Setter方法.属性名：含税总金额
* 创建日期:2019-8-30
* @param newLocal_money_cr nc.vo.pub.lang.UFDouble
*/
...
/**
* 属性 pk_balatype的Getter方法.属性名：结算方式
*  创建日期:2019-8-30
* @return nc.vo.cmp.bill.Payway
*/
public java.lang.Integer getPk_balatype() {
return this.pk_balatype;
} 

/**
* 属性pk_balatype的Setter方法.属性名：结算方式
* 创建日期:2019-8-30
* @param newPk_balatype nc.vo.cmp.bill.Payway
*/
public void setPk_balatype ( java.lang.Integer pk_balatype) {
this.pk_balatype=pk_balatype;
} 
 
/**
* 属性 recaccount的Getter方法.属性名：收款银行账户
*  创建日期:2019-8-30
...
/**
* 属性recaccount的Setter方法.属性名：收款银行账户
* 创建日期:2019-8-30
* @param newRecaccount nc.vo.bd.bankaccount.BankAccSubVO
*/
...
* @return String
*/
public String getPk_distribution(){
return this.pk_distribution;
}
/**
* 属性生成上层主键的Setter方法.属性名：上层主键
* 创建日期:2019-8-30
* @param newPk_distribution String
*/
public void setPk_distribution(String pk_distribution){
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("tg.carrybus");
    }
   }
