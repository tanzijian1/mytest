...
public class Targetbus extends SuperVO {
...
return this.pk_target;
}
/**
* 属性生成上层主键的Setter方法.属性名：上层主键
* 创建日期:2019-9-6
* @param newPk_target String
*/
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("tg.targetbus");
    }
   }
