...
public class Targetactivation extends SuperVO {
	
/**
*单据主键
*/
public java.lang.String pk_target;
/**
*集团
*/
...
/**
* 属性 pk_target的Getter方法.属性名：单据主键
*  创建日期:2019-9-6
* @return java.lang.String
*/
public java.lang.String getPk_target() {
return this.pk_target;
} 

/**
* 属性pk_target的Setter方法.属性名：单据主键
* 创建日期:2019-9-6
* @param newPk_target java.lang.String
*/
public void setPk_target ( java.lang.String pk_target) {
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("tg.targetactivation");
    }
   }
