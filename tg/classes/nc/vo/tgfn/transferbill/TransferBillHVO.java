...
public class TransferBillHVO extends SuperVO {
	
/**
*筹转定转账单表头主键
*/
public java.lang.String pk_transferbill_h;
/**
*集团
*/
...
/**
* 属性 pk_transferbill_h的Getter方法.属性名：筹转定转账单表头主键
*  创建日期:2019-8-29
* @return java.lang.String
*/
public java.lang.String getPk_transferbill_h() {
return this.pk_transferbill_h;
} 

/**
* 属性pk_transferbill_h的Setter方法.属性名：筹转定转账单表头主键
* 创建日期:2019-8-29
* @param newPk_transferbill_h java.lang.String
*/
public void setPk_transferbill_h ( java.lang.String pk_transferbill_h) {
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("tg.transferBillHVO");
    }
   }
