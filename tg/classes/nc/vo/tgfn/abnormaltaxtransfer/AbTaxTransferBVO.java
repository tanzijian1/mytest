...
public class AbTaxTransferBVO extends SuperVO {
	
/**
*非正常税额转出工单表体主键
*/
public java.lang.String pk_abtaxtransfer_o;
/**
*摘要
*/
...
*上层单据主键
*/
public String pk_abtaxtransfer_h;
/**
*时间戳
*/
...
/**
* 属性 pk_abtaxtransfer_o的Getter方法.属性名：非正常税额转出工单表体主键
*  创建日期:2019-9-17
* @return java.lang.String
*/
public java.lang.String getPk_abtaxtransfer_o() {
return this.pk_abtaxtransfer_o;
} 

/**
* 属性pk_abtaxtransfer_o的Setter方法.属性名：非正常税额转出工单表体主键
* 创建日期:2019-9-17
* @param newPk_abtaxtransfer_o java.lang.String
*/
public void setPk_abtaxtransfer_o ( java.lang.String pk_abtaxtransfer_o) {
this.pk_abtaxtransfer_o=pk_abtaxtransfer_o;
} 
...
/**
* 属性def1的Setter方法.属性名：借方科目
* 创建日期:2019-9-17
* @param newDef1 nc.vo.bd.account.AccAsoaVO
*/
...
/**
* 属性def2的Setter方法.属性名：贷方科目
* 创建日期:2019-9-17
* @param newDef2 nc.vo.bd.account.AccAsoaVO
*/
...
* @return String
*/
public String getPk_abtaxtransfer_h(){
return this.pk_abtaxtransfer_h;
}
/**
* 属性生成上层主键的Setter方法.属性名：上层主键
* 创建日期:2019-9-17
* @param newPk_abtaxtransfer_h String
*/
public void setPk_abtaxtransfer_h(String pk_abtaxtransfer_h){
this.pk_abtaxtransfer_h=pk_abtaxtransfer_h;
} 
/**
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("tg.AbTaxTransferBVO");
    }
   }
