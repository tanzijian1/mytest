...
public class TaxCalculationHead extends SuperVO {
	
/**
*单据主键
*/
public java.lang.String pk_taxcalhead;
/**
*集团
*/
...
/**
* 属性 pk_taxcalhead的Getter方法.属性名：单据主键
*  创建日期:2019-9-26
* @return java.lang.String
*/
public java.lang.String getPk_taxcalhead() {
return this.pk_taxcalhead;
} 

/**
* 属性pk_taxcalhead的Setter方法.属性名：单据主键
* 创建日期:2019-9-26
* @param newPk_taxcalhead java.lang.String
*/
public void setPk_taxcalhead ( java.lang.String pk_taxcalhead) {
...
/**
* 属性 pk_deptid的Getter方法.属性名：经办部门
*  创建日期:2019-9-26
...
/**
* 属性pk_deptid的Setter方法.属性名：经办部门
* 创建日期:2019-9-26
* @param newPk_deptid nc.vo.vorg.DeptVersionVO
*/
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("tg.TaxCalculationHead");
    }
   }
