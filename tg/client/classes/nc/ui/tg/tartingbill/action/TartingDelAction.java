...
public class TartingDelAction extends nc.ui.pubapp.uif2app.actions.pflow.DeleteScriptAction{
	@Override
	public void doAction(ActionEvent e) throws Exception {
		...
		String url =PropertiesUtil.getInstance("ebs_url.properties").readValue("SALEURL");//销售回写
			...
			AggTartingBillVO billvo=(AggTartingBillVO)obj;
			TartingBillVO hvo=(TartingBillVO)billvo.getParentVO();
			...
			String sql="select to_char(g.num) as ncdocnum from tg_tartingbill_h t inner join fip_relation f  on f.src_relationid=t.pk_tartingbill_h inner join  gl_voucher  g on   g.pk_voucher =f.des_relationid   where t.pk_tartingbill_h='"+hvo.getPk_tartingbill_h()+"'";
