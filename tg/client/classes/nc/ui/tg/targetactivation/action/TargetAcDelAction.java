...
public class TargetAcDelAction extends nc.ui.pubapp.uif2app.actions.pflow.DeleteScriptAction{
	@Override
	public void doAction(ActionEvent e) throws Exception {
		...
		String url =PropertiesUtil.getInstance("ebs_url.properties").readValue("SALEURL");//销售回写
			...
			AggTargetactivation billvo=(AggTargetactivation)obj;
			Targetactivation hvo=(Targetactivation)billvo.getParentVO();
			...
			String sql="select t.def1 as saleid,'1' as ispzid,t.billno, to_char(g.num) as ncdocnum,'1' as shr,'' as pk_tradetype from tgfn_targetactivation t inner join fip_relation f  on f.src_relationid=t.pk_target inner join  gl_voucher  g on   g.pk_voucher =f.des_relationid  where pk_target='"+hvo.getPk_target()+"'";
