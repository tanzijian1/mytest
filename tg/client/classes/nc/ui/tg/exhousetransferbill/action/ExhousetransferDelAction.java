...
public class ExhousetransferDelAction extends nc.ui.pubapp.uif2app.actions.pflow.DeleteScriptAction{
	@Override
	public void doAction(ActionEvent e) throws Exception {
		...
		String url =PropertiesUtil.getInstance("ebs_url.properties").readValue("SALEURL");//销售回写
			...
			AggExhousetransferbillHVO billvo=(AggExhousetransferbillHVO)obj;
			ExhousetransferbillHVO hvo=(ExhousetransferbillHVO)billvo.getParentVO();
			...
			String sql="select  to_char(g.num) as ncdocnum from tgfn_exhousetransferbill_h t inner join fip_relation f  on f.src_relationid=t.pk_exhoutranbill_h inner join  gl_voucher  g on   g.pk_voucher =f.des_relationid   where t.pk_exhoutranbill_h='"+hvo.getPk_exhoutranbill_h()+"'";
