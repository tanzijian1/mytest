...
public class ImageScanningAction extends NCAction{
	...
	public void doAction(ActionEvent e) throws Exception {
		// TODO 自动生成的方法存根
		AggChangeBillHVO aggChangeBillHVO = (AggChangeBillHVO) model.getSelectedData();
		ChangeBillHVO changeBillHVO = aggChangeBillHVO.getParentVO();
		String barcode = changeBillHVO.getDef3();
		String saleID = changeBillHVO.getDef1();
