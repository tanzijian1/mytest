...
public class RenameChangeDelAction extends nc.ui.pubapp.uif2app.actions.pflow.DeleteScriptAction{
	@Override
	public void doAction(ActionEvent e) throws Exception {
		...
		String url =PropertiesUtil.getInstance("ebs_url.properties").readValue("SALEURL");//销售回写
			...
			AggRenameChangeBillHVO billvo=(AggRenameChangeBillHVO)obj;
			RenameChangeBillHVO hvo=(RenameChangeBillHVO)billvo.getParentVO();
			...
			String sql="select  to_char(g.num) as ncdocnum from tgfn_renameChangeBill_h t inner join fip_relation f  on f.src_relationid=t.pk_renamechbill_h inner join  gl_voucher  g on   g.pk_voucher =f.des_relationid   where pk_renamechbill_h='"+hvo.getPk_renamechbill_h()+"'";
