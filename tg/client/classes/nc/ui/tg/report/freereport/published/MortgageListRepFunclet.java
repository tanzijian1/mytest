...
import nc.ui.iufo.freereport.published.PublishedRepFunclet;

public class MortgageListRepFunclet extends FreeReportFunclet {
	public static final String DEFAULT_PUBLISHED_ZIOR_FILE = ModuleConstants.MODULE_PATH
			+ "bi/zior/zior-mortgagelist-published.xml";
