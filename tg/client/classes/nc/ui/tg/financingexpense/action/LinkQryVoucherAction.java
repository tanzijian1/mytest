...
public class LinkQryVoucherAction extends NCAction {
	...
	public void doAction(ActionEvent e) throws Exception {
		...
		String billtype =	getBillTypeCodeByPK((String) aggvo.getParentVO().getAttributeValue("transtypepk"));
	...
	private String getBillTypeCodeByPK(String billtypeid) throws BusinessException {
		...
		String sql = "SELECT pk_billtypecode FROM bd_billtype WHERE pk_billtypeid = '"
			...
			String	billtypecode	=(String) as[0];
