...
public class LinkQryVoucherAction extends NCAction {
	...
	public void doAction(ActionEvent e) throws Exception {
		...
		// 凭证预览需要单据类型编码
		String billtype = String
				.valueOf(aggvo.getParentVO().getAttributeValue("transtype") == null ? aggvo
						.getParentVO().getAttributeValue("billtype") : aggvo
						.getParentVO().getAttributeValue("transtype"));
		...
		String tmpBilltype = (String) iUAPQueryBS.executeQuery(sql, parameter,
				new ColumnProcessor());
		if (tmpBilltype != null)
			billtype = tmpBilltype;
		// 凭证预览需要单据类型编码
