...
import nc.vo.tgfn.costaccruebill.CostAccrueBill;
...
public class ImageScanningAction extends NCAction{
	...
	public void doAction(ActionEvent e) throws Exception {
		// TODO 自动生成的方法存根
		AggCostAccrueBill aggCostAccrueBill =   (AggCostAccrueBill) model.getSelectedData();
		CostAccrueBill costAccrueBill = aggCostAccrueBill.getParentVO();
		String barcode = costAccrueBill.getPk_costaccruebill_h()+costAccrueBill.getBilltype();
