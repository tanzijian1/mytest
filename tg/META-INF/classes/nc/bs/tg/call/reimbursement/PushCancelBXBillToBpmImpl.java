...
/**
 * BPM撤销流程接口 2020年9月21日09:44:32
 * 
 * @author ln
 * 
 */
public class PushCancelBXBillToBpmImpl extends TGImplCallHttpClient {
	...
	public CallImplInfoVO getImplInfo(String dessystem, String methodname,
		...
		info.setClassName("nc.bs.tg.call.reimbursement.PushCancelBXBillToBpmImpl");
