 ...
 * 
 */
public class EsPayablebillCreateForArrivalImpl extends EstiPayableBillUtils {
	...
	protected void setItemVO(EstiPayableBillVO headVO,
		...
		if (!StringUtils.isBlank(body.getString("materieltype"))) {
			...
			if (materieltype == null) {
				throw new BusinessException("物料分类["
						+ body.getString("materieltype") + "]未在NC关联到信息");
			}
