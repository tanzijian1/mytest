...
public class BusinessContractBxBillUtils extends BusinessBillUtils{
	private static BusinessContractBxBillUtils utils;
	public static BusinessContractBxBillUtils newInstance(){
		if(utils==null){
			utils=new BusinessContractBxBillUtils();
		}
		return utils;
	}
	/**
	...
	try{
		...
		ItfUtils.notNullCheckAndExFormula("264X-Cxx-SY001_HEAD", "264X-Cxx-SY001_BODY", billVO);
		...
		resultVO.setBillid(billNo);
			...
			logVO.setDesbill("商业新非合同类费用请款单写入接口");
