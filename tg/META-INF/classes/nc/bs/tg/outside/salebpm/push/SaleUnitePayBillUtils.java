 ...
 */
public class SaleUnitePayBillUtils extends SaleBPMBillUtils {
	static SaleUnitePayBillUtils utils;

	public static SaleUnitePayBillUtils getUtils() {
		if (utils == null) {
			utils = new SaleUnitePayBillUtils();
		}
		return utils;
	}
