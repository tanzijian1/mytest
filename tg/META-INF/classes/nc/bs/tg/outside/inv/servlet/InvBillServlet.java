package nc.bs.tg.outside.inv.servlet;
...
import nc.bs.tg.outside.inv.utils.InvBillUtils;
...
public class InvBillServlet extends HttpServlet implements IHttpServletAdaptor {
	...
	public void doAction(HttpServletRequest request,
		...
		try {
			...
			logVO.setSrcsystem("INV");
			logVO.setExedate(new UFDateTime().toString());
			logVO.setResult(InvBillUtils.STATUS_SUCCESS);
			logVO.setOperator(InvBillUtils.OperatorName);
			...
			String result = NCLocator.getInstance()
					.lookup(ISyncInvBillServcie.class)
