...
public class PlateBillUtils extends EBSBillUtils{
	...
	public String onSyncBill(HashMap<String, Object> value, String dectype) throws BusinessException {
		...
		throw new BusinessException("接口已停用,请联系NC管理员");
...
//			}else{
//				throw new BusinessException("操作失败，板块编码是必填项，请检查参数设置");
//			}
...
//			}else{
//				throw new BusinessException("操作失败，板块名称是必填项，请检查参数设置");
//			}
//			
//			//上级档案
...
//			}else{
//				throw new BusinessException("操作失败，板块id是必填项，请检查参数设置");
//			}
//			//EBS传母项目档案id
