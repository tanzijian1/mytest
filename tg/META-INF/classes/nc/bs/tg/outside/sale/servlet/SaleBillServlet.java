...
public class SaleBillServlet extends HttpServlet implements IHttpServletAdaptor {
	...
	public void doAction(HttpServletRequest request,
		...
		try {
			...
			logVO.setOperator(SaleBillUtils.SaleOperatorName);

			if (josn == null) {
				throw new BusinessException("来源参数信息为空,请查看传参设置!");
			}

			sc = SaleBillUtils.getUtils().token("ISyncSaleBillServcie:" + josn,
			...
			logVO.setDesbill(SaleBillCont.getBillNameMap().get(billytpe));
