 ...
 * 
 */
public class AutoPushLLSettledBX2BpmTask implements IBackgroundWorkPlugin {
				...
				try {
					BXVO aggVO = (BXVO) getBillVO(
							...
							"isnull(dr,0)=0 and pk_jkbx = '"
									+ map.get("pk_jkbx") + "'");
					String billno = (String) aggVO.getParentVO().getDjbh();
					msgObj[0] = billno;
					// 推送bpm
					String tradetype = aggVO.getParentVO().getDjlxbm();
					String pk = (String) map.get("pk_settlement");
					Map<String, Object> map1 = new HashMap<String, Object>();
					String taskid = aggVO.getParentVO().getZyx30();
	...
	private List<Map<String, Object>> getSettInfoCurrent()
		...
		sql.append("      and t.settlestatus = 5 and t.pk_billtype = '264X' and t.pk_tradetype in('264X-Cxx-LL01','264X-Cxx-LL02','264X-Cxx-LL03') ");
